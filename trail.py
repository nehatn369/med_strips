	...
	def analysis():
                ...
                for line in Lines:
                        if line in o_name:
                                ...
                                window.columnconfigure(e,weight=1, uniform='third')
                                e = tk.Entry(relief=tk.GROOVE)
                                e.grid(row=r, column=1, sticky=tk.NSEW)
                                e.insert(tk.END,ds)
                                window.columnconfigure(e,weight=1, uniform='third')
                                r+=1
                ...
                remedies2.grid(column=0, row=15, padx=10, pady=10)
...
background_image = tk.PhotoImage(file="C:/Users/nehat/Desktop/m6.png")
...
# Heading
heading = tk.Label(window, text="Medicine Name Extractor", font=("Helvetica", 23, "bold"))
heading.pack(pady=11)

# Sub-heading
sub_heading = tk.Label(window, text="Click below to upload doctos prescription and medicine strips", font=("Helvetica", 13))
sub_heading.pack()
...
# Search box
search_box = tk.Entry(window, width=40)
search_box.pack()
...
# Extract button
extract_button = tk.Button(window, text="Extract", command=analysis)
extract_button.pack(pady=10)

# Description box
description_box = tk.Text(window, height=20, width=80)
description_box.pack(pady=10)

last_heading = tk.Label(window, text="Please visit doctor before having the medicine", font=("Helvetica", 13))
last_heading.pack()

title = tk.Label(text="Click below to upload the Doctors Prescription", background = "mintcream", fg="Black", font=("Small Fonts", 17))
title.grid()
